...
python examples/interactive_play_cv_record.py --save-obs --save-obs-fname "/path/to/habitat/play"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-obs-keys", type=str, nargs="+", default=['head_rgb', 'head_depth'], help="List of observation keys to save.")
